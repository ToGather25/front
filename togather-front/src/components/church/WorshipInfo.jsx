...
export default function WorshipInfo() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
      <div>
        <h3 className="text-sub-tit-4 font-semibold text-grey-11 mb-6">정기 예배</h3>
        <table className="w-full text-body-2 text-center border-t border-bluegrey-3">
          <tbody>
      ...
      <div>
        <h3 className="text-sub-tit-4 font-semibold text-grey-11 mb-6">주일학교 예배</h3>
        <table className="w-full text-body-2 text-center border-t border-bluegrey-3">
          <tbody>

          ...
          <div className="w-full flex gap-10 items-end">
            ...
            {loading ? (
              ...
              <div
                ...
                className="flex-[1.5] h-[450px] rounded-3xl px-10 pb-10 flex flex-col justify-end cursor-pointer shadow-2xl transition-shadow relative overflow-hidden group"
                style={{

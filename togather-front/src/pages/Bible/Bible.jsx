...
export default function Bible() {
  return (
    <div className="max-w-[1576px] mx-auto px-4 py-20 flex flex-col items-center">
      <h1 className="text-2xl font-bold text-grey-12 mb-16 text-center">
        오늘 하실 신앙 활동은 무엇인가요?
      </h1>
      <div className="flex gap-6">
        ...
        >
          <span className="text-xl font-semibold">성경 쓰기</span>
        ...
        >
          <span className="text-xl font-semibold">성경 읽기</span>
          <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>

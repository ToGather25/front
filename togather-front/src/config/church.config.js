    ...
    items: [
      {
        ...
        detailedDescription: [
          { title: "예배 및 모임", text: "말씀의 존재와 성령 중만함으로 가정 직장사회를 변화시키는 믿은 안심" },
        ],
      },
      {
        label: "기도 공동체",
        ...
        detailedDescription: [
          { title: "새벽기도회/수요기도회", text: "성경강해 중심 (신신사, 모세오경, 선지사)" },
          { title: "특별새벽기도회", text: "신년, 고난주간, 여름방학, 새학년준제" },
          { title: "중보/은기죽 기도회", text: "담임목사선교 중보기도, 매혼 마지막 금은알 은기죽 기도회" },
        ],
      },
      {
        label: "선도 공동체",
        ...
        detailedDescription: [
          { title: "전도 활동", text: "우도진도, 주임진도, 계절진도(부활주일), 전 도점심 및 진도측회" },
          { title: "선교 봉사", text: "국내 미자립교회 및 선교자 후원, 주파 중과대 선교사 및 방문 선교사 심김" },
        ],
      },
      {
        label: "무지개 공동체",
        ...
        detailedDescription: [
          { title: "주요 행사", text: "온기죽에(5월 3일), 가정세미나(5월 10일), 홍충 4주절(10월 18일)" },
          { title: "운영 인사", text: "교회 성정인 따라 시설 및 예산을 지원하여 정긴 적으로 확대 시행" },
        ],
      },
    ],
  },

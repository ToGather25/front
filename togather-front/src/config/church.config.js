...
const churchConfig = {
  ...
  greeting: {
    ...
    paragraphs: [
      ...
      "셋째, 저희 교회는 다음세대를 길러내는 교회입니다.\n저희 교회는 유치부, 초등부, 중고등부, 대학부, 청년부들에게 하나님의 말씀인 성경을 가르치고, 보수적인 신앙을 전수하고 또 받아 자라도록 노력하는 주님의 교회입니다.",
      "이렇게 저희 투게더교회는 주의 복음과 사랑을 자녀들에게 전수하고, 이곳과 세계에 전파 하기 위해 노력하는 주님의 교회입니다. 감사합니다.",
    ],
    signature: {
      church: "투게더교회",
      title: "담임목사",
  ...
  vision: {
    year: 2026,
    mainTitle: "투게더교회 공동체 비전 ToGather",
  ...
  floorGuide: [
    ...
    { floor: "B1층", rooms: "중고등부실, 초등부실, 소회의실1, 소회의실2, 소회의실3" },
  ],
